...
public interface PlayerServiceInterface {
	...
	//Retrieves a player by their id. Returns an optional containing the player if found, or an empty Optional if not found.
	Optional<Player> getPlayerById(Long playerId);
	
	//Retrieves a list of players by their team name. Returns a list of Player objects belonging to the specified team.
	List<Player> getPlayersByTeam(String teamName);
	
	//Creates a new player. Returns an optional containing the created player, or an empty optional if creation fails.
	...
	//Updates an existing player with the specified id. Returns an optional containing the updated player if successful, 
	...
	//Deletes all players belonging to a specific team. Returns true if the deletion is successful, 
	//false otherwise.
