...
document.addEventListener('DOMContentLoaded', function(event) {
	...
	createMultiplePlayersSubmitButton.addEventListener('click', function(event) {
		...
		for (let player of players) {
			...
			//checking if each player object has the necessary fields (playerName, jerseyNumber, and teamName)
			if (!player.playerName || !player.jerseyNumber || !player.teamName || !player.totalGoals || !player.totalAssists) {
